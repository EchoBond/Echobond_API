...
/**
 * Servlet implementation class TagSelfServlet
 */
public class TagSelfServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private Properties sqlProperties;
	private UserDao dao;
	private Logger log = LogManager.getLogger("TagSelf");
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TagSelfServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dao.untagSelfAll(reqJSON);
		JSONObject result = dao.tagSelf(reqJSON);
