...
/**
 * Servlet implementation class FollowGroupServlet
 */
public class FollowGroupServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private Properties sqlProperties;
	private UserDao dao;
	private Logger log = LogManager.getLogger("FollowGroup");
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FollowGroupServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dao.unfollowAllGroups(reqJSON);
		JSONObject result = dao.followGroups(reqJSON);
